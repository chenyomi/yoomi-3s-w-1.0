import{f as R,M as v,g as O,F as M,h as p,U as b,V as o,i as u,H as c,N as x,j as A,k as g,l as z,m as T,R as L,n as U,o as S,p as F,W as Q,S as V,A as G,P as I,D as w,a as X,B as Z,c as B,C as N,O as W}from"./OrbitControls-9a794e07.js";const y={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`,blending:F,depthTest:!1,depthWrite:!1,transparent:!0})}}f.BlurDirectionX=new o(1,0);f.BlurDirectionY=new o(0,1);class $ extends m{constructor(e,t,a=null,i=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=a,this.clearColor=i,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new g}render(e,t,a){const i=e.autoClear;e.autoClear=!1;let r,s;this.overrideMaterial!==null&&(s=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor)),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:a),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=s),e.autoClear=i}}class te{constructor(e){this.options={container:"#box",pro:"0",clientX:100,clientY:100,clientZ:100,clientR:10,L1X:500,L1Y:400,L1Z:-300,L2X:-500,L2Y:400,L2Z:300},this.animation=null,this.domBox=null,this.cardBox=null,this.composer=null,this.scene=null,this.camera=null,this.controls=null,this.v2=null,this.renderer=null,this.updata(e)}disWebGl(){cancelAnimationFrame(this.animation),this.animation=null,this.domBox.innerHTML="",this.scene.clear(),this.cardBox=null,this.renderer.forceContextLoss(),this.renderer.dispose(),this.renderer=null,this.camera=null,this.composer=null,this.v2=null,this.scene=null,this.controls=null}updata(e){this.theme=localStorage.getItem("theme"),this.options=Object.assign(this.options,e),this.cardBox=document.querySelector(this.options.container),this.renderer=new Q({antialias:!0}),this.renderer.setSize(this.cardBox.clientWidth,this.cardBox.clientHeight),this.renderer.setClearColor(0,0),this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.shadowMap.enabled=!0,this.scene=new V;const t=new G(200);this.scene.add(t),t.position.x=-this.options.clientX/2-10,t.position.z=-this.options.clientZ/2-10,t.position.y=-this.options.clientY/2-10,this.v2=new o(this.cardBox.clientWidth,this.cardBox.clientHeight),this.camera=new I(75,this.cardBox.clientWidth/this.cardBox.clientHeight,.1,1e3),this.camera.position.set(0,1.2*this.options.clientZ,1.2*this.options.clientZ);const a=new w(15658734,this.theme=="light"?2:1);a.position.set(this.options.L1X,this.options.L1Y,this.options.L1Z),this.scene.add(a);const i=new w(15658734,this.theme=="light"?2:1);i.position.set(this.options.L2X,this.options.L2Y,this.options.L2Z),this.scene.add(i);const r=new X(11184810,this.theme=="light"?3:2);this.scene.add(r);let s=null;this.options.pro=="0"?s=new v(new Z(this.options.clientX,this.options.clientZ,this.options.clientY),new B({color:10408703})):s=new v(new N(this.options.clientR,this.options.clientR,this.options.clientZ),new B({color:10408703})),s.position.set(0,0,0),this.scene.add(s),this.composer=new J(this.renderer);const n=new $(this.scene,this.camera);this.composer.addPass(n);const l=new f(this.v2,this.scene,this.camera);l.selectedObjects=[s],this.composer.addPass(l);const d=()=>{this.composer.render(),this.animation=requestAnimationFrame(d)};d(),this.controls=new W(this.camera,this.renderer.domElement),this.domBox=document.querySelector("#box"),this.renderer.domElement.setAttribute("class","fadeIn"),this.domBox.appendChild(this.renderer.domElement)}}export{te as c};
